...
# MAGIC %sql
# MAGIC SELECT path FROM READ_FILES('/Volumes/ttan_demo_catalog_main/ai_agent_apps/raw_data/pdf_documentation/', format => 'binaryFile') limit 2
...
# MAGIC   FROM READ_FILES('/Volumes/ttan_demo_catalog_main/ai_agent_apps/raw_data/pdf_documentation/', format => 'binaryFile') limit 2
...
# MAGIC       FROM READ_FILES('/Volumes/ttan_demo_catalog_main/ai_agent_apps/raw_data/pdf_documentation/', format => 'binaryFile') 
